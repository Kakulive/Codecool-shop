...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        productDataStore.add(new Product("ASUS ROG Pugio II RGB Ambidextrous Wireless", new BigDecimal("219"), "USD", "The ambidextrous ROG Pugio II gaming mouse has leveled up to become premier choice for the fastest, fittest and finest gamers.", mice, asus));
        productDataStore.add(new Product("MSI Clutch GM50 Gaming Mouse", new BigDecimal("89"), "USD", "Perfect for rapid movements and clicks thanks to lightweight design and highly durable gaming switches rated for 20 million clicks.", mice, msi));
        productDataStore.add(new Product("ASUS ROG Strix Scope Deluxe RGB Mechanical Gaming Keyboard", new BigDecimal("389"), "USD", "Extend your battlefield prowess with ROG Strix Scope, the mechanical gaming keyboard with Xccurate Design – an extra-wide Ctrl key for FPS precision.", keyboards, asus));
        productDataStore.add(new Product("Corsair K100 RGB Mechanical Gaming Keyboard", new BigDecimal("569"), "USD", "The K100 RGB’s refined design features a durable aluminium frame and dynamic per-key RGB backlighting accented by a 44-zone three-sided RGB LightEdge.", keyboards, corsair));
        productDataStore.add(new Product("ROCCAT Vulcan TKL Compact Mechanical RGB Gaming Keyboard", new BigDecimal("229"), "USD", "The ROCCAT® Vulcan TKL Compact Mechanical RGB Gaming Keyboard presents the award-winning Titan Switch Mechanical in the smaller form factor.", keyboards, roccat));
    }
}
